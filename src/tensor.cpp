...
//	orthogonalize();
	...
	// add comments!
	double **A;
	A = compress(r1, r2, r3, g, eps, r1_tmp, r2_tmp, r3_tmp);

	double* g_tmp = new double[r1_tmp * r2_tmp * r3_tmp];
	LAPACKE_dlacpy (LAPACK_ROW_MAJOR, 'A', r1_tmp * r2_tmp * r3_tmp, 1, A[0], 1, g_tmp, 1);
	delete [] g;
	g = g_tmp;
